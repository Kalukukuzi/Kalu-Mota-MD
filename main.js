...
const connectionOptions = {
  ...
  browser: ['Bumblebee Bot', 'Safari', '1.0.0'],
  version,
...
const directories = ['./BumbleSession/', './jadibts/']
...
async function connectionUpdate(update) {
  ...
  if (update.qr != 0 && update.qr != undefined) {
    console.log(chalk.yellow('🚩ㅤㅤScan this QR code, the QR code expires in 60 seconds.'));
  }
  if (connection == 'open') {
    console.log(chalk.yellow('▣──────────────────────────────···\n│\n│❧ 𝗦𝗨𝗖𝗖𝗘𝗦𝗦𝗙𝗨𝗟𝗟𝗬  𝗖𝗢𝗡𝗘𝗖𝗧𝗘𝗗 𝗧𝗢 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣✅\n│\n▣──────────────────────────────···'));
  }
...
setInterval(async () => {
  ...
  const bio = `🐝 𝗔𝗖𝗧𝗜𝗩𝗘 𝗧𝗜𝗠𝗘: ${uptime} ┃ 👑 𝗚𝗘𝗡© 𝗕𝘆 𝗕𝗨𝗠𝗕𝗟𝗘-𝗕𝗼𝗧  ┃:
